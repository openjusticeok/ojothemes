...
#'
#' Color palettes used in the Open Justice Oklahoma.
#'
#' @export
#' @param palette Palette name.
ojo_color_pal <- function(palette = "categorical") {
  palette_list <- palette_ojo
...
#' Discrete color scale that aligns with the Open Justice Oklahoma style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
scale_color_discrete <- function(...) {
  ggplot2::discrete_scale("colour", "ojo", ojo_color_pal("categorical"), ...)
}
...
#' Discrete fill scale that aligns with the Open Justice Oklahoma style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
scale_fill_discrete <- function(...) {
  ggplot2::discrete_scale("fill", "ojo", ojo_color_pal("categorical"), ...)
}

#' Continuous fill scale that aligns with the Open Justice Oklahoma style
#'
#' @md
...
#' Discrete fill scale for ordinal factors that aligns with the Open Justice Oklahoma style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
...
#' Discrete color scale for ordinal factors that aligns with the Open Justice Oklahoma style
#'
#' @md
#' @param ... other arguments passed to \code{discrete_scale()}
#' @export
